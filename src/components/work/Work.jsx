                ...
                {data.map((d) => (
                    <div className="container">
                        <div className="item">
                            ...
                            <div className="right">
                                <img src="https://99designs-blog.imgix.net/blog/wp-content/uploads/2018/10/attachment_100040756-e1538485934255.jpeg?auto=format&q=60&fit=max&w=930" alt="Test image"/>
                            </div>
                        </div>
                    </div>
                ))
